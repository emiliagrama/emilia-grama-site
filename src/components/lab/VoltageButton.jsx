...
export default function VoltageButton({
  ...
  return (
    <div className={`labVoltage ${className}`}>
      <Tag
        className="labVoltage__btn"
        {...(isButton ? { type, onClick } : {})}
      >
        {children}
      </Tag>

      <svg
        className="labVoltage__svg"
      ...
      >
        ...
        <path
          className="labVoltage__line labVoltage__line--1"
        ...
        />
        <path
          className="labVoltage__line labVoltage__line--2"
      ...
      <div className="labVoltage__dots" aria-hidden="true">
        <span className="labVoltage__dot labVoltage__dot--1" />
        <span className="labVoltage__dot labVoltage__dot--2" />
        <span className="labVoltage__dot labVoltage__dot--3" />
        <span className="labVoltage__dot labVoltage__dot--4" />
        <span className="labVoltage__dot labVoltage__dot--5" />
      </div>

      <style>{`.labVoltage__line{filter:url(#${filterId});}`}</style>
    </div>
  );
}